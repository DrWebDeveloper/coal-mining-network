    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><?php echo app('translator')->get('Login your account'); ?></h3>
                <button type="button" class="btn-close text-white" data-bs-dismiss="modal" aria-label="Close">
                    <i class="las la-times"></i>
                </button>
            </div>
            <div class="modal-body">
                <form class="account-form verify-gcaptcha" action="<?php echo e(route('user.login')); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
                    ...
                    <div class="form-group d-flex justify-content-between">
                        ...
                        <a href="#" class="text-white" data-bs-toggle="modal" data-bs-target="#resetModal"
                            data-bs-dismiss="modal"><?php echo app('translator')->get('Forgot Password'); ?>?</a>
                    </div>
                    <button type="submit" class="btn btn--base w-100"><?php echo app('translator')->get('Login'); ?></button>
                    <p class="text-center mt-3"><span class="text-white"><?php echo app('translator')->get('Don\'t have an account'); ?>?
                        </span> <a href="#0" class="text--base" data-bs-toggle="modal"
                            data-bs-target="#registerModal" data-bs-dismiss="modal"> <?php echo app('translator')->get('Register'); ?></a></p>
                </form>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="registerModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><?php echo app('translator')->get('Create an account'); ?></h3>
                <button type="button" class="btn-close text-white" data-bs-dismiss="modal" aria-label="Close">
                    <i class="la la-times"></i>
                </button>
            </div>
            <div class="modal-body">
                <form class="account-form registration-form verify-gcaptcha" action="<?php echo e(route('user.register')); ?>"
                    method="post">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="name" type="text" class="form--control checkUser" name="name"
                                    value="<?php echo e(old('name')); ?>" required>
                                <small class="text-danger nameExist"></small>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
...
<?php endif; ?>
                    ...
                    <button type="submit" id="recaptcha"
                        class="btn btn--base w-100 mt-3"><?php echo app('translator')->get('Register'); ?></button>
                    <p class="text-center mt-3"><span class="text-white"> <?php echo app('translator')->get('Have an account'); ?>? </span> <a
                            href="#0" class="text--base" data-bs-toggle="modal" data-bs-target="#loginModal"
                            data-bs-dismiss="modal"><?php echo app('translator')->get('Login'); ?></a></p>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn--danger text-white" data-bs-dismiss="modal"><?php echo app('translator')->get('Close'); ?></button>

                <button type="button" class="btn btn--base ex-email" data-bs-dismiss="modal" data-bs-toggle="modal"
                    data-bs-target="#loginModal"><?php echo app('translator')->get('Login'); ?></button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="resetModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><?php echo app('translator')->get('Reset Password'); ?></h3>
                <button type="button" class="btn-close text-white" data-bs-dismiss="modal" aria-label="Close">
                    <i class="la la-times"></i>
                </button>
            </div>
            <div class="modal-body">
                <form class="account-form" method="POST" action="<?php echo e(route('user.password.email')); ?>">
                    ...
                    <button type="submit" class="btn btn--base w-100"><?php echo app('translator')->get('Send Password Code'); ?></button>
                    <p class="text-center mt-3"><span class="text-white"><?php echo app('translator')->get('Have been remembering'); ?>?</span> <a href="#0"
...
<?php $__env->startPush('script'); ?>
    <script>
        ...
        $(document).ready(function() {
            ...
            let anyError = '<?php echo e(@$errors->any()); ?>';

            let modalType = '<?php echo e(Session::get('modalType')); ?>';

            if (anyError || modalType) {
                let errorModal = '<?php echo e(Session::get('modal')); ?>';
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/umar/Sites/localhost/coal-mining-network/core/resources/views/templates/basic/partials/modal.blade.php ENDPATH**/ ?>