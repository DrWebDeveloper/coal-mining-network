    ...
    <div class="row gy-4 mt-2">
        <div class="col-lg-4 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--primary">
                ...
                <div class="widget-two__content">
                    <h3 class="text-white"><?php echo e($widget['total_plans']); ?></h3>
                    <p class="text-white"><?php echo app('translator')->get('Total Plan'); ?></p>
                </div>
                <a class="widget-two__btn" href="<?php echo e(route('admin.plan.index')); ?>"><?php echo app('translator')->get('View All'); ?></a>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-lg-4 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--1">
                ...
                <div class="widget-two__content">
                    <h3 class="text-white"><?php echo e($widget['running_investments']); ?></h3>
                    <p class="text-white"><?php echo app('translator')->get('Running Investments'); ?></p>
                </div>
                <a class="widget-two__btn" href="<?php echo e(route('admin.report.investments')); ?>/?status=<?php echo e(Status::RUNNING); ?>"><?php echo app('translator')->get('View All'); ?></a>
            </div>
        </div><!-- dashboard-w1 end -->
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--19">
                ...
                <div class="widget-two__content">
                    <h3 class="text-white"><?php echo e($widget['completed_investments']); ?></h3>
                    <p class="text-white"><?php echo app('translator')->get('Complated Investments'); ?></p>
                </div>

                <a class="widget-two__btn" href="<?php echo e(route('admin.report.investments')); ?>/?status=<?php echo e(Status::COMPLETED); ?>"><?php echo app('translator')->get('View All'); ?></a>
            </div>
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/coalqjrb/public_html/core/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>