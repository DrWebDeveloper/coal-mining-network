    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item <?php echo e(menuActive('admin.plan.index')); ?>">
                    <a href="<?php echo e(route('admin.plan.index')); ?>" class="nav-link ">
                        <i class="menu-icon las la-project-diagram"></i>
                        <span class="menu-title"><?php echo app('translator')->get('Manage Plans'); ?></span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu <?php echo e(menuActive('admin.report*',2)); ?> ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item <?php echo e(menuActive(['admin.report.investments','admin.report.investments.search'])); ?>">
                                <a href="<?php echo e(route('admin.report.investments')); ?>" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('Investment Log'); ?></span>
                                </a>
                            </li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/coalqjrb/public_html/core/resources/views/admin/partials/sidenav.blade.php ENDPATH**/ ?>