                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('user.withdraw.money')); ?>" method="post">
                            ...
                            <div class="form-group">
                                <label><?php echo app('translator')->get('Method'); ?></label>
                                <select class="form-select form--control" name="method_code" required>
                                    <option value="" disabled selected><?php echo app('translator')->get('Select Gateway'); ?></option>
...
<?php echo $__env->make($activeTemplate.'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/coalqjrb/public_html/core/resources/views/templates/basic/user/withdraw/methods.blade.php ENDPATH**/ ?>